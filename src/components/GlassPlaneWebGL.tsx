  ...
  return (
    <group position={[xWorld, yWorld, 0]}>
      ...
      <mesh>
        ...
        <fastGlassMaterial
          uTexture={bgTexture}
          uIor={item.props.distortion ?? -0.15} // Negative for "convex" lens feel
          uColor={new THREE.Color(item.props.tintColor || "#ffffff")}
          uTintStrength={item.props.tintStrength ?? 0.15}
